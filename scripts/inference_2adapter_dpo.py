...
class InferenceConfig:
    ...
    factual_adapter_path: str = chz.field(
        description="Path to factual adapter (tinker:// or experiments/.../factual)"
    )
    creative_adapter_path: str = chz.field(
        description="Path to creative adapter (tinker:// or experiments/.../creative)"
    )
    ...
    output_dir: str = chz.field(
        default="inference_results/2adapter_dpo",
